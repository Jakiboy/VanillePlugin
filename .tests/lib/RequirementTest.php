...
use VanillePluginTest\int\RequirementInterfaceTest;
use VanillePluginTest\int\PluginNameSpaceInterfaceTest;
use VanillePluginTest\inc\FileTest;

class RequirementTest extends NoticeTest implements RequirementInterfaceTest
{
	/**
	...
	{
		if ( FileTest::exists($this->getPluginDir("/{$slug}/{$slug}.php")) ) {
			return true;
		}
	}
